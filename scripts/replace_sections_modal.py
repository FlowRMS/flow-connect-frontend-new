...
# Find the start line (Sections Settings Modal comment)
start_line = None
end_line = None

for i, line in enumerate(lines):
    if '{/* Sections Settings Modal */}' in line:
        start_line = i
    if start_line is not None and '{/* Rep Commission Splits Modal */}' in line:
        end_line = i
        break
...
print(f"Found Sections Settings Modal from line {start_line + 1} to {end_line}")

# Create the replacement
replacement = '''        {/* Sections Settings Modal */}
