...
for i, line in enumerate(lines):
    if '{/* Copy Price Modal */}' in line:
        start_line = i
    if start_line is not None and '{/* Price Lookup Modal' in line:
        end_line = i
        break
...
print(f"Found Copy Price Modal from line {start_line + 1} to {end_line}")

replacement = '''                {/* Copy Price Modal */}
                <CopyPriceModal
