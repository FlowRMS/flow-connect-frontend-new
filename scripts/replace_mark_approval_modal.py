...
for i, line in enumerate(lines):
    if '{/* Mark Approval Status Modal */}' in line:
        start_line = i
    if start_line is not None and '{/* Revert to Version Modal */}' in line:
        end_line = i
        break
...
print(f"Found Mark Approval Status Modal from line {start_line + 1} to {end_line}")

replacement = '''        {/* Mark Approval Status Modal */}
