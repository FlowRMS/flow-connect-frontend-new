...
for i, line in enumerate(lines):
    if '{/* PDF Preview Modal */}' in line:
        start_line = i
    if start_line is not None and '{/* Print Submittal Modal */}' in line:
        end_line = i
        break
...
print(f"Found PDF Preview Modal from line {start_line + 1} to {end_line}")

replacement = '''        {/* PDF Preview Modal */}
        <PdfPreviewModal
