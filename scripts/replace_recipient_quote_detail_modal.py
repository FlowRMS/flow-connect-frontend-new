...
for i, line in enumerate(lines):
    if '{/* Recipient Quote Detail Modal */}' in line:
        start_line = i
    if start_line is not None and '{/* Create Submittal Modal */}' in line:
        end_line = i
        break
...
print(f"Found Recipient Quote Detail Modal from line {start_line + 1} to {end_line}")

replacement = '''        {/* Recipient Quote Detail Modal */}
