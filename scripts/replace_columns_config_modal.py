...
for i, line in enumerate(lines):
    if '{/* Columns Configuration Modal */}' in line:
        start_line = i
    if start_line is not None and '{/* Mark as Lost Modal */}' in line:
        end_line = i
        break
...
print(f"Found Columns Configuration Modal from line {start_line + 1} to {end_line}")

replacement = '''        {/* Columns Configuration Modal */}
        <ColumnsConfigModal
