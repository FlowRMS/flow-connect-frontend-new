...
for i, line in enumerate(lines):
    if '{/* Approval Request Modal - Enhanced */}' in line:
        start_line = i
    if start_line is not None and '{/* PDF Preview Modal */}' in line:
        end_line = i
        break
...
print(f"Found Approval Request Modal from line {start_line + 1} to {end_line}")

replacement = '''        {/* Approval Request Modal - Enhanced */}
