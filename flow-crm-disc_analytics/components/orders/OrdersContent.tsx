                ...
                filteredOrders.map((order) => (
                  ...
                  >
                    <div className="col-span-2">
                      ...
                      {order.poNumber && (
                        <div className="text-xs text-[var(--muted-foreground)]">PO: {order.poNumber}</div>
                      )}
                      {order.jobName && (
                        <div className="text-xs text-[var(--muted-foreground)] truncate">{order.jobName}</div>
                      )}
                    </div>
                    <div className="col-span-2 flex items-center">
                    ...
                    <div className="col-span-1 flex items-center">
                      <span className="text-sm text-[var(--muted-foreground)]">{formatDate(order.orderDate)}</span>
                    </div>
                    <div className="col-span-1 flex items-center justify-end">
                    ...
                    <div className="col-span-2 flex items-center gap-2">
                      <span className={`px-2 py-0.5 text-xs rounded ${fulfillmentStatusColors[order.fulfillmentStatus]}`}>
                        {fulfillmentStatusLabels[order.fulfillmentStatus]}
                      </span>
                      <span className={`px-2 py-0.5 text-xs rounded ${billingStatusColors[order.billingStatus]}`}>
        ...
        <div className="fixed right-0 top-0 bottom-0 w-[480px] bg-[var(--card)] border-l border-[var(--border)] overflow-y-auto shadow-xl">
          ...
          <div className="p-6 space-y-6">
            ...
            <div className="flex gap-3 pt-4 border-t border-[var(--border)]">
              ...
              {selectedOrder.billingStatus !== 'invoiced' && selectedOrder.fulfillmentStatus === 'completed' && (
