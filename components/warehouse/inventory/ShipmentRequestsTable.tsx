...
interface ShipmentRequestsTableProps {
    ...
    onEdit: (request: ShipmentRequest) => void;
                                ...
                                >
                                    ...
                                    <td className="px-6 py-4">
                                        <span className={`inline-flex items-center gap-1.5 px-2 py-1 rounded text-xs font-medium ${request.requestMethod === 'EMAIL' ? 'bg-blue-100 text-blue-700' :
                                            request.requestMethod === 'PHONE_CALL' ? 'bg-green-100 text-green-700' :
                                            ...
                                            {request.requestMethod === 'PHONE_CALL' && (
                                                <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                                    ...
                                    <td className="px-6 py-4 text-sm text-[var(--foreground)]">{formatQuantity(request.totalQuantity)}</td>
                                            ...
                                            {request.status === 'DRAFT' && (
                                                <>
                                                    <button
                                                        ...
                                                        className="px-2 py-1 text-xs font-medium text-blue-700 hover:bg-blue-50 rounded transition-colors"
                                                        title="Edit Draft"
                                                    >
                                                        Edit
                                                    </button>
                ...
                {requests.length === 0 && (
                    <div className="px-6 py-12 text-center text-[var(--muted-foreground)]">
                        ...
                        <button
                            ...
                            className="mt-2 text-sm text-[var(--primary)] hover:underline focus:outline-none"
                        >
