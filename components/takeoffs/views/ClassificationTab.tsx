                  ...
                  <div className="flex items-center gap-2">
                    ...
                    {doc.abridged && (
                      doc.abridgedUrl ? (
                        ...
                        >
                          {doc.abridgedPages ?? doc.pages}/{doc.pages} pages kept ({doc.pages && doc.pages > 0 ? Math.round(((doc.pages - (doc.abridgedPages ?? doc.pages)) / doc.pages) * 100) : 0}% reduction - below threshold)
                        </span>
                      )
                    )}
