...
import { useIsMobile } from "@/lib/analytics/hooks/use-mobile";
...
function Sidebar({
  ...
  // Temporarily disabled mobile check to debug
  // if (isMobile) {
  //   return (
  ...
  //         data-slot="sidebar"
  //         data-mobile="true"
  //         className="bg-sidebar text-sidebar-foreground w-[var(--sidebar-width)] p-4 rounded-none sm:rounded-lg"
  //         style={{
