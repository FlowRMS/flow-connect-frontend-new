    ...
    <div className="bg-white rounded-xl border border-gray-200 shadow-sm mb-6">
      ...
      <div className="p-6">
        ...
        <div className="mt-5">
          ...
          <textarea
            value={isEditing ? editFormData.additionalInformation || '' : job.additionalInformation || ''}
            onChange={handleChange('additionalInformation')}
            rows={3}
            className={`${inputBaseClass} resize-none`}
            readOnly={!isEditing}
            placeholder={isEditing ? "Enter additional information..." : "No additional information"}
          />
        </div>

        {/* Structural Information - Two Column Grid */}
        <div className="mt-5 grid grid-cols-2 gap-5">
          <div>
            ...
            <textarea
              value={isEditing ? editFormData.structuralInformation || '' : job.structuralInformation || ''}
              onChange={handleChange('structuralInformation')}
              rows={3}
              className={`${inputBaseClass} resize-none`}
              readOnly={!isEditing}
              placeholder={isEditing ? "Enter structural information..." : "No structural information"}
            />
          </div>
          <div>
            <label className={labelClass}>
            ...
            <textarea
              value={isEditing ? editFormData.structuralDetails || '' : job.structuralDetails || ''}
              onChange={handleChange('structuralDetails')}
              rows={3}
              className={`${inputBaseClass} resize-none`}
              readOnly={!isEditing}
              placeholder={isEditing ? "Enter structural details..." : "No structural details"}
            />
          </div>
        </div>
