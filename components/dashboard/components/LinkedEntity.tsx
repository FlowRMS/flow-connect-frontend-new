 ...
 * Displays a linked entity badge with icon and name
 */
...
/**
 * Get icon component for linked entity type
 */
function getLinkedEntityIcon(type: string): React.ReactNode {
  switch (type.toUpperCase()) {
    case 'JOB':
      return (
...
export function LinkedEntity({ type, name }: LinkedEntityProps) {
  return (
    <span
      className={`px-2 py-0.5 rounded text-xs font-medium flex items-center gap-1 ${getLinkedEntityColor(type)}`}
    >
      {getLinkedEntityIcon(type)}
