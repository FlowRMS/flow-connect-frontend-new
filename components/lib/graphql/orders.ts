/**
 * Orders GraphQL Module
 * Centralized GraphQL queries and mutations for orders
 */
...
export type OrderType = 'NORMAL' | 'BLANKET' | 'RELEASE' | 'TAG' | 'HOLD_FOR_RELEASE' | 'STORM' | string;
