...
export default function DataSearchTable() {
  ...
  const fetchData = useCallback(async () => {
    ...
    try {
      ...
      const response = await fetch(`/api/disc/data-search?${params}`);
  ...
  }, [currentPage, sortConfig, selectedState, selectedCategory, selectedYear]);
    ...
    <div className="flex-1 overflow-hidden flex flex-col p-6 bg-[var(--background)]">
        ...
        <div className="flex items-center gap-6">
          ...
          <div className="flex items-center gap-4 flex-1">
            <div className="flex flex-col gap-1">
              <label className="text-xs font-medium text-[var(--muted-foreground)] uppercase">Filter By</label>
              <select
                value={selectedState}
                onChange={(e) => { setSelectedState(e.target.value); handleFilterChange(); }}
      ...
      <div className="flex-1 bg-[var(--card)] border border-[var(--border)] rounded-xl overflow-hidden flex flex-col">
        ...
        <div className="px-6 py-4 border-b border-[var(--border)]">
          <h2 className="text-lg font-semibold text-[var(--foreground)]">Data Search Report</h2>
        </div>
              ...
              <table className="w-full">
                ...
                <tbody>
                  {data.map((row, idx) => (
                    ...
                    >
                      <td className="px-6 py-4 text-sm text-[var(--foreground)] border-b border-[var(--border)]">{row.state}</td>
                      <td className="px-6 py-4 text-sm text-[var(--foreground)] border-b border-[var(--border)]">{row.county}</td>
