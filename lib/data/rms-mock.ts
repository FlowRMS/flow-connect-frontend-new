...
export const mockOrders: Order[] = [
  ...
  },
  {
    ...
    lineItems: [
      ...
      },
      {
        ...
        partNumber: 'DERA-2X4-40L-840',
        description: '2x4 LED Troffer, 4000K, 4000 lumens',
        quantity: 45,  // Was 50, reduced by 5 due to credit (Return)
        unitPrice: 145.00,
        extendedPrice: 6525.00,  // 45 * 145
        commissionRate: 0.10,
        commissionAmount: 652.50,  // 6525 * 0.10
        quantityShipped: 0,
        quantityInvoiced: 0,
        quantityCredited: 5,
        isCancelled: false,
      ...
      },
      {
        ...
        quantity: 30,
        unitPrice: 195.00,
        extendedPrice: 5850.00,
        commissionRate: 0.09,
        commissionAmount: 526.50,
        quantityShipped: 0,
        quantityInvoiced: 0,
        quantityCredited: 0,
        isCancelled: false,
      ...
      },
      {
        ...
        lineNumber: 5,
        productId: 'PROD-006',
        partNumber: 'EXP-LED-4FT',
        description: 'Explosion Proof LED 4ft, Hazardous Location',
        quantity: 13,  // Was 15, reduced by 2 due to credit (Damage)
        unitPrice: 450.00,
        extendedPrice: 5850.00,  // 13 * 450
        commissionRate: 0.12,
        commissionAmount: 702.00,  // 5850 * 0.12
        quantityShipped: 0,
        quantityInvoiced: 0,
        quantityCredited: 2,
        isCancelled: false,
      ...
      },
      {
        id: 'OLI-005-6',
        lineNumber: 6,
        description: 'Order-Level Credit - Freight Damage Allowance',
        quantity: -1,
        unitPrice: 500.00,
        ...
        notes: 'Credit for freight damage on initial shipment',
      },
    ],
    subtotal: 71225.00,
    freight: 1250.00,
    total: 72475.00,
    totalCommission: 6621.00,
    insideRepId: 'REP-003',
    insideRepName: 'Mike Thompson',
    splitRates: [
    ...
    lineItems: [
      {
        ...
        partNumber: 'DERA-LED-2X2',
        description: '2x2 LED Recessed Troffer',
        quantity: 140,  // Was 150, reduced by 10 due to credit
        unitPrice: 165.00,
        extendedPrice: 23100.00,  // 140 * 165
        commissionRate: 0.10,
        commissionAmount: 2310.00,
        quantityShipped: 0,
        quantityInvoiced: 0,
        quantityCredited: 10,  // 10 units credited
        isCancelled: false,
        isConsignment: false,
      },
      {
      ...
      },
      {
        id: 'OLI-006-3',
        lineNumber: 3,
        description: 'Order-Level Credit - Pricing Adjustment',
        quantity: -1,
        unitPrice: 750.00,
        ...
        creditType: 'cancel',
        linkedLineItemId: null,
        notes: 'Pricing adjustment for bulk order discount',
      },
    ],
    subtotal: 36600.00,
    freight: 350.00,
    total: 36950.00,
    totalCommission: 3660.00,
    insideRepId: 'REP-003',
    insideRepName: 'Mike Thompson',
    splitRates: [
  ...
  // Example order with 4 line items linked to an invoice with no line items
  {
    id: 'ORD-007',
    orderNumber: 'SO-2024-0007',
    factorySoNumber: 'FAC-SO-2024-0007',
    manufacturerId: 'MFG-001',
    manufacturerName: 'Acuity Brands',
    customerId: 'CUST-002',
    customerName: 'McCarthy Building',
    ...
    lineItems: [
      {
        ...
        lineNumber: 1,
        productId: 'PROD-007',
        partNumber: 'LED-PANEL-A',
        description: 'LED Panel Light Type A, 2x2',
        quantity: 10,
        unitPrice: 100.00,
        extendedPrice: 1000.00,
        commissionRate: 0.10,
      ...
      },
      {
        ...
        lineNumber: 2,
        productId: 'PROD-008',
        partNumber: 'LED-PANEL-B',
        description: 'LED Panel Light Type B, 2x4',
        quantity: 20,
        unitPrice: 50.00,
        extendedPrice: 1000.00,
        commissionRate: 0.10,
      ...
      },
      {
        ...
        lineNumber: 3,
        productId: 'PROD-009',
        partNumber: 'LED-HIGHBAY-C',
        description: 'LED High Bay Light Type C',
        quantity: 5,
        unitPrice: 200.00,
        extendedPrice: 1000.00,
        commissionRate: 0.10,
      ...
      },
      {
        ...
        lineNumber: 4,
        productId: 'PROD-010',
        partNumber: 'LED-STRIP-D',
        description: 'LED Strip Light Type D, 10ft',
        quantity: 15,
        unitPrice: 100.00,
      ...
      },
      {
        id: 'OLI-007-5',
        lineNumber: 5,
        description: 'Credit - Defective Panel Return',
        quantity: -2,
        unitPrice: 100.00,
        ...
        isCredit: true,
        creditType: 'return',
        linkedLineItemId: 'OLI-007-1',
        notes: 'Customer returned 2 defective LED Panel A units',
      },
    ],
    subtotal: 4300.00,
    freight: 200.00,
    ...
    insideRepName: 'Mike Thompson',
    splitRates: [
      { salesRepId: 'REP-001', salesRepName: 'John Mitchell', splitPercentage: 60, commissionAmount: 270.00 },
      { salesRepId: 'REP-003', salesRepName: 'Mike Thompson', splitPercentage: 40, commissionAmount: 180.00 },
    ],
    poNumber: 'PO-MB-2024-0007',
...
export const mockInvoices: Invoice[] = [
  ...
  // Example invoice with NO line items - will show "Unknown line items" placeholder
  {
    id: 'INV-004',
    ...
    lineItems: [
      {
        id: 'ILI-004-1',
        orderLineItemId: 'OLI-007-1', // Links to LED Panel A - has credit applied
        lineNumber: 1,
        partNumber: 'LED-PANEL-A',
        description: 'LED Panel Light Type A, 2x2',
        quantity: 8, // Original was 10, minus 2 for credit
        unitPrice: 100.00,
        amount: 800.00,
        commissionRate: 0.10,
    ...
    freight: 0,
    total: 2800.00,
    totalCommission: 280.00,
    amountPaid: 0,
    amountCredited: 200.00, // Credit from OLI-007-5
    balance: 2600.00,
    splitRates: [
      { salesRepId: 'REP-001', salesRepName: 'John Mitchell', splitPercentage: 60, commissionAmount: 150.00 },
      { salesRepId: 'REP-003', salesRepName: 'Mike Thompson', splitPercentage: 40, commissionAmount: 100.00 },
    ],
...
export const mockChecks: CommissionCheck[] = [
  ...
  },
  {
    ...
    manufacturerId: 'MFG-002',
    manufacturerName: 'Kidde',
    commissionMonth: '2025-09',
    status: 'POSTED',
    checkDate: '2025-11-11',
    ...
    details: [
      {
        ...
        description: 'Sample Commission Entry',
        amount: 500.00,
        customerName: 'Sample Customer',
        orderNumber: 'SO-2025-0001',
      },
    ],
    invoicePayments: 500.00,
    expenseAdjustments: 6.95,
    creditDeductions: 0,
    netAmount: 500.00,
    checkBalance: 493.05,
    createdBy: 'System',
  ...
  {
    id: 'CHK-004',
    checkNumber: 'ck-flow-6187',
    salesRepId: 'REP-001',
    salesRepName: 'John Mitchell',
    manufacturerId: 'MFG-003',
    manufacturerName: 'Power Partners',
    commissionMonth: '2025-11',
    status: 'POSTED',
    postDate: '2025-11-07',
    checkDate: '2025-11-07',
    ...
    details: [
      {
        ...
        type: 'invoice',
        referenceId: 'INV-004',
        referenceNumber: 'INV-2025-0004',
        description: 'Power Partners Commission',
        amount: 54022.18,
        customerName: 'Industrial Electric',
        orderNumber: 'SO-2025-0004',
      },
    ],
    invoicePayments: 54022.18,
    expenseAdjustments: 0,
    creditDeductions: 0,
    netAmount: 54022.18,
    checkBalance: 0.00,
  ...
  {
    id: 'CHK-005',
    checkNumber: 'ck-flow-6180',
    salesRepId: 'REP-003',
    salesRepName: 'Mike Thompson',
    manufacturerId: 'MFG-004',
    manufacturerName: 'Richards Manufacturing Company',
    commissionMonth: '2025-11',
    status: 'POSTED',
    postDate: '2025-11-06',
    checkDate: '2025-11-06',
    entryDate: '2025-11-19',
    createdDate: '2025-11-19',
    details: [
      {
        ...
        type: 'invoice',
        referenceId: 'INV-005',
        referenceNumber: 'INV-2025-0005',
        description: 'Richards Manufacturing Commission',
        amount: 167557.39,
        customerName: 'Major Construction Co',
        orderNumber: 'SO-2025-0005',
      },
    ],
    invoicePayments: 167557.39,
    expenseAdjustments: 0,
    creditDeductions: 0,
    netAmount: 167557.39,
    checkBalance: 0.00,
...
export function getOrderSummaryStats(): OrderSummaryStats {
  ...
  return {
    ...
    shippedOrders: mockOrders.filter(o => o.status === 'SHIPPED_COMPLETE').length,
